                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">
                        <ul class="nav navbar-nav">
                            <li class="nav-item <?php if ($active == "index") {
                                print(" active");
                            } ?>"><a class="nav-link" href="/stephaniejackson/index">Home</a></li>
                            <li class="nav-item <?php if ($active == "about") {
                                print(" active");
                            } ?>"><a class="nav-link" href="/stephaniejackson/about">About</a></li>
                            <li class="nav-item <?php if ($active == "treatments") {
                                print(" active");
                            } ?>">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                           href="/stephaniejackson/treatments/eyebrows">Eyebrows</a>
                                        <a class="dropdown-item"
                                           href="/stephaniejackson/treatments/eyeliner">Eyeliner</a>
                                        <a class="dropdown-item" href="/stephaniejackson/treatments/lip_blush">Lip
                                            Blush</a>
                                        <a class="dropdown-item" href="/stephaniejackson/treatments/beauty_spot">Beauty
                                            Spot</a>
                                        <a class="dropdown-item" href="/stephaniejackson/treatments/lvl">LVL</a>
                                    </div>
                                </div>
                            </li>
                            <li class="nav-item <?php if ($active == "pricing") {
                                print(" active");
                            } ?>"><a class="nav-link" href="/stephaniejackson/pricing">Pricing</a></li>
                            <li class="nav-item <?php if ($active == "gallery") {
                                print(" active");
                            } ?>">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="/stephaniejackson/gallery/lip_blush">Lip
                                            Blush</a>
                            ...
                            <li class="nav-item <?php if ($active == "reviews") {
                                print(" active");
                            } ?>"><a class="nav-link" href="/stephaniejackson/reviews">Reviews</a></li>
                            <li class="nav-item <?php if ($active == "termsandconditions") {
                                print(" active");
                            } ?>"><a class="nav-link" href="/stephaniejackson/termsandconditions">Terms & Conditions</a>
                            </li>
                            <li class="nav-item <?php if ($active == "contact") {
                                print(" active");
                            } ?>"><a class="nav-link" href="/stephaniejackson/contact">Contact</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
